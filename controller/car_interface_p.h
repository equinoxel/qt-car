 ...
 * Command line was: dbusxml2cpp -c CarInterface -p car_interface_p.h:car_interface.cpp -i mystruct.h car.xml
 *
...
#ifndef CAR_INTERFACE_P_H_1174528488
#define CAR_INTERFACE_P_H_1174528488
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusReply<MyStruct> structer(qlonglong &out1)
    {
        QList<QVariant> argumentList;
        QDBusMessage reply = callWithArgumentList(QDBus::Block, QLatin1String("structer"), argumentList);
